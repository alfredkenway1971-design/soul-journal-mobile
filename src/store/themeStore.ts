...
export const THEME_OPTIONS = [
  {
    key: "mint",
    labelKey: "themes.optionMint",
    descKey: "themes.optionMintDesc",
    swatch: "#e0f2e9",
    gradient: ["#f0f5f1", "#e8f0ea", "#fcfefb"],
  },
  {
    key: "sky",
    labelKey: "themes.optionSky",
    descKey: "themes.optionSkyDesc",
    swatch: "#b1d1f1",
    gradient: ["#d2ecf9", "#b1d1f1", "#c4dff3"],
  },
  {
    key: "lilac",
    labelKey: "themes.optionLilac",
    descKey: "themes.optionLilacDesc",
    swatch: "#d8c9ef",
    gradient: ["#ede6f8", "#d9cdf0", "#e6dcf6"],
  },
  {
    key: "peach",
    labelKey: "themes.optionPeach",
    descKey: "themes.optionPeachDesc",
    swatch: "#f7d9c4",
